...
class SuccessByUserTab extends StatefulWidget {
  final Session? session;
  const SuccessByUserTab({super.key, this.session});

  @override
  State<SuccessByUserTab> createState() => _SuccessByUserTabState();
}

class _SuccessByUserTabState extends State<SuccessByUserTab> {
  ...
  _loadResources() async {
    ...
    await HistoryService()
        .getSessionComplete(UserProfile.user!.userId!)
        .then((value) {
      sessions = value;
    });
    setState(() {
