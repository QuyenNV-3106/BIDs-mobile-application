...
class CompleteByUserTab extends StatefulWidget {
  final Session? session;
  const CompleteByUserTab({super.key, this.session});

  @override
  State<CompleteByUserTab> createState() => _CompleteByUserTabState();
}

class _CompleteByUserTabState extends State<CompleteByUserTab> {
  ...
  _loadResources() async {
    ...
    await HistoryService()
        .getSessionCompleteByUser(UserProfile.user!.userId!)
        .then((value) {
      sessions = value;
    });
    setState(() {
