...
class ErrorByUserTab extends StatefulWidget {
  final Session? session;
  const ErrorByUserTab({super.key, this.session});

  @override
  State<ErrorByUserTab> createState() => _ErrorByUserTabState();
}

class _ErrorByUserTabState extends State<ErrorByUserTab> {
  ...
  _loadResources() async {
    ...
    await HistoryService()
        .getSessionErrorByUser(UserProfile.user!.userId!)
        .then((value) {
      sessions = value;
    });
    setState(() {
