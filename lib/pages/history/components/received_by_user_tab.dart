...
class ReceivedByUserTab extends StatefulWidget {
  final Session? session;
  const ReceivedByUserTab({super.key, this.session});

  @override
  State<ReceivedByUserTab> createState() => _ReceivedByUserTabState();
}

class _ReceivedByUserTabState extends State<ReceivedByUserTab> {
  ...
  _loadResources() async {
    ...
    await HistoryService()
        .getSessionReceivedByUser(UserProfile.user!.userId!)
        .then((value) {
      sessions = value;
    });
    setState(() {
