      ...
      children: [
        SizedBox(
          ...
          child: AspectRatio(
            aspectRatio: 1,
            child: Hero(
              tag: widget.session.sessionId.toString(),
              child: widget.session.images.isEmpty
                  ? Image.asset(noImage)
                  : Image.network(
                      widget.session.images[selectedImage].detail,
                      fit: BoxFit.fitWidth,
        ...
        SingleChildScrollView(
          ...
          child: Row(
            ...
            children: [
              ...List.generate(widget.session.images.length,
  ...
  GestureDetector buildSmallProductPreview(int index) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Image.network(
          widget.session.images[index].detail,
          loadingBuilder: (context, child, loadingProgress) =>
